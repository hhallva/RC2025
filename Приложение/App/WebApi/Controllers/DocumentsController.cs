...
namespace WebApi.Controllers
{
    ...
    public class DocumentsController(AppDbContext context) : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>Получает спискок всех документов из базы данных</remarks>
        ...
        /// </summary>
        ///<remarks>Принимает id необходимого документа и возрващает списко комментариев оставленных у него</remarks>
        ...
        /// </summary>
        ///<remarks>Принимает id документа и комментарий, и сохраняет этот комменатрий в базе данных</remarks>
